...
const webpackCommon = require("./webpackCommonStrings");

const webpackImportResolve = require("./webpack.config.resolve");
      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
            ...
            {
              test: /\.colored\.svg/,
              include: [path.resolve(paths.appRoot), path.resolve(paths.appRoot, "node_modules/ct-pwa")],
              use: [
                {
                  loader: require.resolve("babel-loader"),
                  query: {
                    presets: webpackCommon.presetArray,
                    plugins: [...webpackCommon.commonPlugin]
                  }
                },
                {
        ...
        loaders: [
          {
            ...
            plugins: [
              ...
              ...webpackCommon.commonRunTimePlugin,
              ...webpackCommon.commonPlugin
            ]
          }
        ]
      }),
