  ...
  _createClass(MonthView, [{
    ...
    value: function renderDays() {
      var _props = this.props,
          ...
          childProps = _objectWithoutProperties(_props, ['calendarType']);

      return _react2.default.createElement(_Month2.default, _extends({ calendarType: this.calendarType }, childProps));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var label = (0, _format2.default)(activeStartDate, "MMMM YYYY");

      return _react2.default.createElement(
        'div',
        { style: style, className: [className].join(' ') },
        _react2.default.createElement(
          'h3',
          { className: 'react-calendar__month-name' },
          label
        ),
        _react2.default.createElement(
          'div',
