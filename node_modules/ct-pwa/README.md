...
* **Summary of set up**
    ...
    2. Enter `yarn` in the root of the repository.
...
* **Starting up the dev server**
    ...
    Enter `yarn start` in the root of the repository.

* **Deployment instructions**

    To create the prod build, enter `yarn run build:sw`
...
* The element returned by the `render` method should have a `className` matching the name of the component (or otherwise identifying the component). This is useful for "namespacing" any CSS/SCSS that go with the component. For example:
...
## Redux
Follow Ducks, a reducer bundling style
###Example
```javascript
// widgets.js
...
Read more at [`ducks-modular-redux`](https://github.com/erikras/ducks-modular-redux).
