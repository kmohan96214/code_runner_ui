...
class TripAdvisorRating extends PureComponent {
  render() {
    const { rating, total, logo, taLogoSize, reviewLogoSize, showRounderRating } = this.props
    ...
    return (
      <Fragment>
        ...
        <If condition={showRounderRating}>
        {Array(roundedRating)
          .fill()
          .map((value, index) => (
            <TACircle
...
TripAdvisorRating.propTypes = {
  ...
  logo: PropTypes.bool,
  showRounderRating:  PropTypes.bool,
