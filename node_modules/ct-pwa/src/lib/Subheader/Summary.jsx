...
const Summary = ({
  ...
  goBackNavigation,
  backButtonClickedFromMap,
  backButtonClickedFromReviews,
  backButtonClickedFromSRP
}) => {
  const handleBackNavigation = () => {
    if (backButtonClickedFromMap) {
      backButtonClickedFromMap();
    }
    if (backButtonClickedFromReviews) {
      backButtonClickedFromReviews();
    }
    if (backButtonClickedFromSRP) {
      backButtonClickedFromSRP();
    }
    goBackNavigation ? goBackNavigation() : goBack(backNavigationParams)
  }
...
Summary.propTypes = {
  ...
  backButtonClickedFromMap: PropTypes.func,
  backButtonClickedFromReviews: PropTypes.func
}
